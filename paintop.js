...
.gulpIcon {
    ...
    object-fit: cover;
    border-radius: 8px;
    border: 6px solid var(--contentColor2);
...
.followTilePic {
    ...
    let fart = new Audio('https://myinstants.com/media/sounds/brain-fart.mp3')
    fart.play();
    ...
    gulpSection.innerHTML = `<button class="custSidebarButton" onclick="loadPage()"><img class="gulpIcon" src="https://photop-content.s3.amazonaws.com/ProfileImages/633b97e3eed8eec90fc997de4b1a2f62"></img>Gulp</button>`;
    wireframes['gulpsection'] = getWireframeCode();
    playSounds();
